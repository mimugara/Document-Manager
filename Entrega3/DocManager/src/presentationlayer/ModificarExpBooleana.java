...
public class ModificarExpBooleana extends javax.swing.JFrame {
    ...
    /**
     * Modificar button to modifie a boolean expression 
     */
    ...
    /**
     * Constructs the ModificarExpBooleana view
     * @param pCtrlPresentacio
     */
    public ModificarExpBooleana(CtrlPresentacio pCtrlPresentacio) {
    ...
    private void initComponents() {
        ...
        labelMenu.setText("MODIFICAR EXPRESSIÓ BOOLEANA");
        ...
        labelQuery.setText("           Nova Expressió Booleana:");
    ...
    /**
     * Modifies the boolean expression when the Modificar button is pressed
     * @param evt
     */
    private void buttonModificarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        String query = textQuery.getText();
        String nom = textNom.getText();
        String arbre;
        textArbre.setText("");
        try {
            iCtrlPresentacio.modificarExpBool(nom, query);
        ...
        labelEstat.setVisible(true);
        labelEstat.setText("Modificada correctament");
    ...
    private void buttonCancelaActionPerformed(java.awt.event.ActionEvent evt) {                                            
        iCtrlPresentacio.sincronitzarModificarExpBooleanaAVistaPrincipal();
        textQuery.setText("");
        textNom.setText("");
        textArbre.setText("");
